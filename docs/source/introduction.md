...
Nous vous conseillons de lire notre [introduction générale dans notre documentation développeur](https://aquarium.app/docs/api/introduction/).
```
...
Ces fonctions vous permettent de gagner du temps en évitant de vous plonger dans [meshQL](https://aquarium.app/docs/api/meshql/), le langage qui permet d'écrire les requêtes dans Aquarium.
